...
public class AdminAdapterDeac extends FirebaseRecyclerAdapter<AdminModel, AdminAdapterDeac.myViewHolder> {
     ...
     * @param options
     */
    public AdminAdapterDeac(@NonNull FirebaseRecyclerOptions<AdminModel> options) {
        super(options);
    }
                ...
                FirebaseDatabase.getInstance().getReference().child("users").child(getRef(position).getKey()).updateChildren(map)
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(holder.FullName.getContext(), "Successfully Deactivated Account", Toast.LENGTH_SHORT).show();
                            }
                        })
                        .addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(holder.FullName.getContext(), "Failed to Deactivate Account", Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        });
    ...
    class myViewHolder extends RecyclerView.ViewHolder {
        ...
        public myViewHolder(@NonNull View itemView) {
            ...
            acctActivate.setText("DEACTIVATE ACCOUNT");
        }
    }
}
