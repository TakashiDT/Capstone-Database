...
public class PendingUsers extends DrawerBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allocateActivityTitle("Admin: Enable Accounts");
    ...
    private void loadData() {
        ...
        FirebaseRecyclerOptions<AdminModel> options =
                new FirebaseRecyclerOptions.Builder<AdminModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("users").orderByChild("activate").equalTo("false"), AdminModel.class)
                        .build();
    ...
    public void onBackPressed() {
        startActivity(new Intent(PendingUsers.this, AdminActivity.class));
        finish();
    }
}